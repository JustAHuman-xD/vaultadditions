...
public class GiftStatueLootConfig extends Config {
    @Expose
    ...
    protected void reset() {
        ...
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.ABYSSAL_ICHOR.getDefaultInstance()), 1));
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.SUBLIME_VAULT_ELIXIR.getDefaultInstance()), 1));
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.SUBLIME_VAULT_SUBSTANCE.getDefaultInstance()), 1));
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.SUBLIME_VAULT_VISION.getDefaultInstance()), 1));
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.PARADOXICAL_GEM.getDefaultInstance()), 1));
        this.LOOT.add(new WeightedList.Entry<>(new SingleItemEntry(ModItems.ACCELERATION_CHIP.getDefaultInstance()), 1));

        this.INTERVAL = 400;
        this.MIN_ITEM_GENERATED = 50;
        this.MAX_ITEM_GENERATED = 250;
    }
