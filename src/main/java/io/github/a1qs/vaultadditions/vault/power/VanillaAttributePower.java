...
public class VanillaAttributePower extends LearnableSkill implements GearAttributeSkill, TickingSkill {
    ...
    static {
        OPERATION_ORDINAL = Adapters.ofEnum(AttributeModifier.Operation.class, EnumAdapter.Mode.ORDINAL);
        OPERATION_NAME = Adapters.ofEnum(AttributeModifier.Operation.class, EnumAdapter.Mode.NAME);
    }
}
