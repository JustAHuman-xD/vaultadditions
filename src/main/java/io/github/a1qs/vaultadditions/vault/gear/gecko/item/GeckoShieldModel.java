...
public class GeckoShieldModel extends ShieldModel implements VaultGeckoModel {
    ...
    public GeckoShieldModel(String id, String type, String displayName, String animationName, float transitionTicks) {
