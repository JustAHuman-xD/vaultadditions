...
public class DindjarinArmorLayers extends ArmorLayers {
    @Override
    ...
    public static class MainLayer extends ArmorLayers.MainLayer {
        ...
        public static LayerDefinition createBodyLayer() {
            ...
            head.addOrReplaceChild("cube_r1", CubeListBuilder.create().texOffs(82, 12).addBox(-1.0F, -2.0F, -1.0F, 2.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(5.0F, -5.0F, 0.0F, 0.0F, 3.1416F, 0.0F));
            head.addOrReplaceChild("cube_r2", CubeListBuilder.create().texOffs(82, 0).addBox(-2.25F, -1.75F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(82, 75).addBox(-0.25F, -1.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(2.75F, -2.25F, -5.0F, 0.0F, -0.3927F, 0.0F));
            head.addOrReplaceChild("cube_r3", CubeListBuilder.create().texOffs(82, 18).addBox(-1.75F, -1.75F, -1.0F, 2.0F, 2.0F, 2.0F, new CubeDeformation(0.0F)).texOffs(46, 77).addBox(0.25F, -1.75F, -1.0F, 2.0F, 5.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-2.75F, -2.25F, -5.0F, 0.0F, 0.3927F, 0.0F));
            ...
            body.addOrReplaceChild("cube_r4", CubeListBuilder.create().texOffs(16, 77).addBox(-3.0F, -2.0F, -1.0F, 6.0F, 4.0F, 2.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 8.25F, -3.25F, 0.3927F, 0.0F, 0.0F));
            body.addOrReplaceChild("cube_r5", CubeListBuilder.create().texOffs(0, 0).addBox(-9.0F, 7.75F, -5.0F, 18.0F, 0.0F, 23.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(0.0F, 3.0F, 15.5F, -1.1781F, 0.0F, 0.0F));
            ...
            right_arm.addOrReplaceChild("cube_r6", CubeListBuilder.create().texOffs(0, 52).addBox(-1.0F, -3.5F, -3.0F, 4.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(-4.0F, -1.25F, -0.5F, 0.0F, 0.0F, 0.3927F));
            ...
            left_arm.addOrReplaceChild("cube_r7", CubeListBuilder.create().texOffs(56, 45).addBox(-1.0F, -3.5F, -3.0F, 4.0F, 7.0F, 7.0F, new CubeDeformation(0.0F)), PartPose.offsetAndRotation(4.0F, -1.25F, 0.5F, 3.1416F, 0.0F, 2.7489F));
