...
public class VaultGeckoModelProvider<T extends VaultArmorItem & IAnimatable> extends AnimatedGeoModel<T> {
    private static final ResourceLocation DEFAULT_MODEL = VaultMod.id("geo/hoytest.geo.json");
    private static final ResourceLocation DEFAULT_TEXTURE = VaultMod.id("textures/item/gear/armor/hoytest/texture.png");
    private static final ResourceLocation DEFAULT_ANIMATION = VaultMod.id("animations/hoytest.animation.json");
